...
function r(e){
var r=e.url,t=r.indexOf("?");
e.report_param="&tid="+e.traceid+"&ticket="+e.ticket+"&aid="+e.aid,r.indexOf("?")>=0?r=r.slice(0,t)+".html"+r.slice(t):r+=".html";
var a=document.getElementsByTagName("mpcpc")[0].dataset.category_id_list,n=e.traceid+":"+a+":"+biz,p={
scene:1067,
sceneNote:n,
userName:e.weapp_info.original_id+"@app",
relativeURL:r,
appVersion:1
},c=!1,m=navigator.userAgent.match(/MicroMessenger\/(\d+)\.(\d+)\.(\d+)/);
if(m){
var s=Number(m[1]),d=Number(m[2]),_=Number(m[3]);
s>6?c=!0:6===s&&d>5?c=!0:6===s&&5===d&&_>=3&&(c=!0);
}
return console.log("canJumpOnTap : ",c,e.weapp_info.original_id,navigator.userAgent),
c?void o.invoke("openWeApp",p,function(r){
"openWeApp:ok"===r.err_msg&&i(125,e.report_param),"system:function_not_exist"===r.err_msg&&(location.href="https://mp.weixin.qq.com/mp/waerrpage?type=upgrade&original_id="+encodeURIComponent(e.weapp_info.original_id)+"#wechat_redirect",
i(126,e.report_param));
...
void i(126,e.report_param));
}
var o=e("biz_wap/jsapi/core.js"),t=e("biz_common/utils/report.js");
return{
openWxopen:r
};
